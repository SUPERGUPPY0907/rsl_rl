...
class ActorCriticFlow(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Policy
        self.actor = Flow(input_dim=mlp_input_dim_a, output_dim=self.a_dim, a_dim=self.a_dim, time_dim=time_dim,
                          time_hidden_dim=time_hidden_dims, actor_hidden_dim=actor_hidden_dims, activation=activation,
                          N=flow_num_steps, p=mix_para, device=device)
    ...
    def act(self, observations, **kwargs):
        action, log_probs = self.actor(observations, jac = False)
